...
SwapChainSupportDetails VulkanTestApplication::querySwapChainSupport(VkPhysicalDevice device) {
...
void VulkanTestApplication::createSwapChain() {
    ...
    std::cout<< vk::to_string(vk::PresentModeKHR(presentMode)) << std::endl;
...
VkSampleCountFlagBits VulkanTestApplication::getMaxUsableSampleCount() {
